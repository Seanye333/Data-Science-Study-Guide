...
SECTIONS = [
...

    {
        ...
        "code2_title": "FunctionTransformer for custom transformations",
        "code2": (
        ...
        "code3_title": "Custom transformer with BaseEstimator and TransformerMixin",
        "code3": (
            "from sklearn.base import BaseEstimator, TransformerMixin\n"
            "from sklearn.pipeline import Pipeline\n"
            "from sklearn.preprocessing import StandardScaler\n"
        ...
        "code4_title": "ColumnTransformer for mixed-type data",
        "code4": (
            "from sklearn.compose import ColumnTransformer\n"
            "from sklearn.preprocessing import StandardScaler, OneHotEncoder\n"
            "from sklearn.impute import SimpleImputer\n"
        ...
        "practice": {
            "title": "Price Prediction Feature Pipeline",
            "desc": "Build a feature engineering pipeline for house prices: (1) Apply log1p to 'sqft' and 'price' (target), (2) Add PolynomialFeatures(degree=2) on numerical features, (3) OneHotEncode 'neighborhood'. Use ColumnTransformer + Pipeline. Report R2 with 5-fold CV.",
            "starter": (
            "from sklearn.pipeline import Pipeline\n"
            "from sklearn.compose import ColumnTransformer\n"
    ...
    },
    {
        ...
        "code2_title": "Precision-Recall curve and optimal threshold",
        "code2": (
            "from sklearn.datasets import make_classification\n"
            "from sklearn.model_selection import train_test_split\n"
            "from sklearn.ensemble import RandomForestClassifier\n"
        ...
        "code3_title": "Confusion matrix, classification report, calibration",
        "code3": (
            "from sklearn.datasets import load_digits\n"
            "from sklearn.model_selection import train_test_split\n"
            "from sklearn.ensemble import RandomForestClassifier\n"
        ...
        "code4_title": "Multi-class ROC with one-vs-rest",
        "code4": (
            "from sklearn.datasets import load_iris\n"
            "from sklearn.model_selection import train_test_split\n"
            "from sklearn.linear_model import LogisticRegression\n"
        ...
        "practice": {
            "title": "Threshold Tuning for Recall",
            "desc": "Train a RandomForest on an imbalanced dataset (weights=[0.9,0.1], 2000 samples). Plot the precision-recall trade-off (print precision and recall at 10 evenly-spaced thresholds). Find and print the threshold that achieves recall >= 0.85 with the highest precision. Show the confusion matrix at that threshold.",
            "starter": (
            "from sklearn.datasets import make_classification\n"
            "from sklearn.model_selection import train_test_split\n"
            "from sklearn.ensemble import RandomForestClassifier\n"
    ...
    },
    {
        ...
        "code2_title": "HistGradientBoostingClassifier (faster, supports NaN)",
        "code2": (
        ...
        "code3_title": "Feature importances and partial dependence",
        "code3": (
            "from sklearn.ensemble import GradientBoostingClassifier\n"
            "from sklearn.datasets import load_breast_cancer\n"
            "from sklearn.model_selection import train_test_split\n"
        ...
        "code4_title": "GBM vs RF vs HistGB comparison",
        "code4": (
            "from sklearn.ensemble import (GradientBoostingClassifier,\n"
        ...
        "practice": {
            "title": "GBM Hyperparameter Grid Search",
            "desc": "Use GridSearchCV with GradientBoostingClassifier on the breast cancer dataset. Search over: n_estimators=[100,200], learning_rate=[0.05,0.1], max_depth=[2,3,4]. Use 5-fold CV with ROC-AUC. Print the best params, best score, and the top 5 parameter combinations.",
            "starter": (
            "from sklearn.ensemble import GradientBoostingClassifier\n"
            "from sklearn.model_selection import GridSearchCV\n"
            "from sklearn.datasets import load_breast_cancer\n"
    ...
    },
    {
        ...
        "code2_title": "RidgeCV and LassoCV for automatic alpha selection",
        "code2": (
        ...
        "code3_title": "Regularization path — how coefficients shrink",
        "code3": (
        ...
        "code4_title": "ElasticNet for correlated features",
        "code4": (
        ...
        "practice": {
            "title": "Regularization Strength Sweep",
            "desc": "Load the diabetes dataset. For Lasso with alpha in [0.01, 0.1, 1, 10, 100], print: alpha, R2 on test set, number of non-zero coefficients, and which features survive (by name). Do the same for Ridge. Conclude: which alpha gives the best test R2 for each method?",
            "starter": (
            "from sklearn.datasets import load_diabetes\n"
    ...
    },
    {
        ...
        "code2_title": "Model versioning with metadata",
        "code2": (
        ...
        "code3_title": "Pickle protocol and cross-version safety checks",
        "code3": (
        ...
        "practice": {
            "title": "Save and Reload Comparison",
            "desc": "Train two models on wine dataset (RandomForest and GradientBoosting). Save both with joblib including metadata (accuracy, params, date). Write a function compare_models(paths) that loads all saved models and prints a comparison table (name, accuracy, train time, file size KB). Save as 'models/' directory.",
            "starter": (
    ...
    },
    {
        ...
        "code2_title": "CountVectorizer + Multinomial Naive Bayes (fast baseline)",
        "code2": (
        ...
        "code3_title": "TF-IDF with GridSearch for hyperparameter tuning",
        "code3": (
            "from sklearn.feature_extraction.text import TfidfVectorizer\n"
        ...
        "practice": {
            "title": "Multi-Class News Classifier",
            "desc": "Use fetch_20newsgroups with 5 categories of your choice. Build a Pipeline: TfidfVectorizer (max_features=15000, ngram_range=(1,2), sublinear_tf=True) + LinearSVC(C=1.0). Evaluate with cross_val_score (5-fold, accuracy). Print the top-5 most informative words per class using the SVC coef_ attribute.",
            "starter": (
            "from sklearn.datasets import fetch_20newsgroups\n"
            "from sklearn.feature_extraction.text import TfidfVectorizer\n"
            "from sklearn.svm import LinearSVC\n"
    ...
    },
    {
        ...
        "code2_title": "LocalOutlierFactor and OneClassSVM comparison",
        "code2": (
        ...
        "code3_title": "Anomaly scores and threshold tuning",
        "code3": (
            "from sklearn.ensemble import IsolationForest\n"
    ...
    },
    {
        ...
        "code2_title": "Gaussian Mixture Models — soft assignments",
        "code2": (
        ...
        "code3_title": "BIC/AIC model selection and silhouette analysis",
        "code3": (
            "from sklearn.mixture import GaussianMixture\n"
            "from sklearn.cluster import KMeans\n"
        ...
        "code4_title": "HDBSCAN-style with DBSCAN density-based clustering",
        "code4": (
            "from sklearn.cluster import DBSCAN\n"
            "from sklearn.preprocessing import StandardScaler\n"
        ...
        "practice": {
            "title": "Hierarchical vs GMM Comparison",
            "desc": "Generate 3 clusters with varying density (n=100 each): dense circle at origin std=0.3, spread at (5,5) std=1.5, elongated at (2,-3) with cov [[4,2],[2,1]]). Compare: AgglomerativeClustering(ward, k=3), GaussianMixture(full, k=3), KMeans(k=3). Print ARI and silhouette for each. Which handles the elongated cluster best?",
            "starter": (
            "from sklearn.cluster import AgglomerativeClustering, KMeans\n"
            "from sklearn.mixture import GaussianMixture\n"
            "from sklearn.preprocessing import StandardScaler\n"
