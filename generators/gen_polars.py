...
OUT = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "modules", "09_polars")
...
"starter": 'import polars as pl\n\ndf = pl.DataFrame({"v": [3, 1, 9, 5]})\n# TODO: df.top_k(2, by="v")\nresult = df\nprint(result)',
...

    {
        ...
        "code2_title": "Query Plan & Optimization",
        "code2": (
            "import polars as pl\n"
            "import numpy as np\n"
            "\n"
        ...
        "code3_title": "Streaming Large Datasets",
        "code3": (
            "import polars as pl\n"
        ...
        "practice": {
            "title": "LazyFrame Pipeline",
            "desc": "Build a LazyFrame pipeline that filters rows, adds a computed column, groups by a category, and collects the result. Check .explain() before collecting.",
            "starter": (
            "import polars as pl\n"
            "import numpy as np\n"
            "\n"
...
"starter": 'import polars as pl\n\ndf = pl.DataFrame({"g": ["a", "a", "b"], "v": [1, 2, 30]})\n# TODO: group_by, sum v, then sort by the summed column descending\nresult = df\nprint(result)',
        ...
        "code2_title": "Rolling & Dynamic GroupBy",
        "code2": (
            "import polars as pl\n"
            "import numpy as np\n"
            "\n"
        ...
        "code3_title": "Conditional Aggregations & Pivot",
        "code3": (
            "import polars as pl\n"
            "import numpy as np\n"
            "\n"
        ...
        "practice": {
            ...
            "desc": "Group a DataFrame by two columns, compute sum, mean, std, and a conditional count. Then pivot the result and sort by the total column.",
            "starter": (
            "import polars as pl\n"
            "import numpy as np\n"
            "\n"
...
"starter": 'import polars as pl\n\na = pl.DataFrame({"v": [1, 2]})\nb = pl.DataFrame({"v": [3]})\n# TODO: pl.concat([a, b])\nresult = a\nprint(result)',
        ...
        "code2_title": "Semi, Anti Joins & Asof Join",
        "code2": (
            "import polars as pl\n"
            "import numpy as np\n"
            "\n"
        ...
        "code3_title": "Join Performance Tips",
        "code3": (
            "import polars as pl\n"
        ...
        "practice": {
            ...
            "desc": "Join three DataFrames using inner and left joins, then use an anti-join to find records in one table that have no match in another.",
            "starter": (
            "import polars as pl\n"
            "import numpy as np\n"
            "\n"
    ...
    },
    {
        ...
        "code2_title": "Regex Extraction & Pattern Matching",
        "code2": (
            "import polars as pl\n"
            "\n"
        ...
        "code3_title": "String Splitting & Parsing",
        "code3": (
            "import polars as pl\n"
            "\n"
            "df = pl.DataFrame({\n"
        ...
        "practice": {
            "title": "String Extraction Pipeline",
            "desc": "Given a column of log lines, extract timestamp, severity level, and message into separate columns using .str.extract() with capture groups.",
            "starter": (
            "import polars as pl\n"
            "\n"
    ...
    },
    {
        ...
        "code2_title": "Time Series Resampling & Windows",
        "code2": (
            "import polars as pl\n"
            "import numpy as np\n"
            "from datetime import datetime, timedelta\n"
        ...
        "code3_title": "Timezone Handling & Duration",
        "code3": (
            "import polars as pl\n"
        ...
        "practice": {
            "title": "DateTime Resampling",
            "desc": "Create a DataFrame with minute-level timestamps, resample to daily averages using dt.date() and group_by, then extract year/month/weekday as new columns.",
            "starter": (
            "import polars as pl\n"
            "import numpy as np\n"
            "from datetime import datetime, timedelta\n"
    ...
    },
    {
        ...
        "code2_title": "Lag, Lead & Shift Features",
        "code2": (
            "import polars as pl\n"
            "import numpy as np\n"
            "\n"
        ...
        "code3_title": "Conditional Expressions & When/Then/Otherwise",
        "code3": (
            "import polars as pl\n"
            "import numpy as np\n"
            "\n"
        ...
        "practice": {
            "title": "Window Functions",
            "desc": "Apply rank, cumulative sum, and lag-1 window functions over a group column. Verify the results have the same row count as the original DataFrame.",
            "starter": (
            "import polars as pl\n"
            "import numpy as np\n"
            "\n"
    ...
    },
    {
        ...
        "code2_title": "Filter & Join Benchmark",
        "code2": (
            "import polars as pl\n"
            "import pandas as pd\n"
            "import numpy as np\n"
        ...
        "code3_title": "Memory Efficiency & Migration Tips",
        "code3": (
            "import polars as pl\n"
            "import pandas as pd\n"
            "import numpy as np\n"
        ...
        "practice": {
            "title": "Pandas to Polars Migration",
            "desc": "Convert a pandas pipeline (filter, groupby, merge) to Polars. Verify the results are equivalent and measure the speedup.",
            "starter": (
            "import polars as pl\n"
            "import pandas as pd\n"
            "import numpy as np, time\n"
    ...
    },
    {
        ...
        "code2_title": "Polars in ML Pipelines",
        "code2": (
            "import polars as pl\n"
            "import numpy as np\n"
            "from sklearn.preprocessing import StandardScaler\n"
        ...
        "code3_title": "ETL Pipeline with Error Handling",
        "code3": (
            "import polars as pl\n"
            "import numpy as np\n"
            "import tempfile, os\n"
        ...
        "practice": {
            ...
            "desc": "Write a Polars ETL function that reads a DataFrame, removes nulls, normalizes a string column to uppercase, joins with a lookup table, and returns aggregated results.",
            "starter": (
            "import polars as pl\n"
            "import numpy as np\n"
            "\n"
